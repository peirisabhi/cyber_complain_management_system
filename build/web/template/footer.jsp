<%-- 
    Document   : footer
    Created on : May 11, 2021, 2:20:56 PM
    Author     : abhi
--%>
...
<footer class="footer-area">
                    ...
                    <div class="footer-content text-center no-padding margin-bottom-40">
                        <div class="logo-footer">
                            <img id="logo-footer" class="center-block"
                                 src="https://templates.scriptsbundle.com/knowledge/demo/images/logo-1.png" alt="">
                        </div>
                        ...
                        <div class="col-lg-7 col-sm-6 col-xs-12 column">
                            <div class="footer-widget about-widget">
                                ...
                                <ul class="contact-info">
                                    <li><span class="icon fa fa-map-marker"></span> 60 Link Road Lhr. Pakistan 54770
                                    </li>
                    ...
                    <div class="row clearfix">
                        ...
                        <div class="col-lg-7 col-sm-6 col-xs-12 column">
                            <div class="footer-widget news-widget">
                                ...
                                <div class="news-post">
                                    ...
                                    <div class="news-content">
                                        <figure class="image-thumb">
                                            <img src="https://templates.scriptsbundle.com/knowledge/demo/images/blog/popular-2.jpg"
                                                 alt="">
                                        </figure>
                                ...
                                <div class="news-post">
                                    ...
                                    <div class="news-content">
                                        <figure class="image-thumb">
                                            <img src="https://templates.scriptsbundle.com/knowledge/demo/images/blog/popular-1.jpg"
                                                 alt="">
                                        </figure>
                                        <a href="#">If you need a crown or lorem an implant you will pay it gap it</a>
                                    </div>
                        ...
                        <div class="col-lg-5 col-sm-6 col-xs-12 column">
                            <div class="footer-widget links-widget">
                                ...
                                <ul>
                                    <li>
                                        <a href="https://templates.scriptsbundle.com/knowledge/demo/login.html">Login</a>
                                    </li>
                                    <li><a href="https://templates.scriptsbundle.com/knowledge/demo/register.html">Register</a>
                                    </li>
                                    <li><a href="https://templates.scriptsbundle.com/knowledge/demo/listing.html">Listing</a>
                                    </li>
                                    <li><a href="https://templates.scriptsbundle.com/knowledge/demo/blog.html">Blog</a>
                                    </li>
                                    <li><a href="https://templates.scriptsbundle.com/knowledge/demo/contact.html">Contact
                                        Us</a>
                                    </li>
    ...
    <div class="footer-copyright">
        <div class="auto-container clearfix">
            <!--Copyright-->
            <div class="copyright text-center">Copyright 2016 &copy; Theme Created By <a target="_blank"
                                                                                         href="http://themeforest.net/user/scriptsbundle/portfolio">Scriptsbundle</a>
                All Rights Reserved
            </div>
        </div>
    </div>
